<div class="py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 mb-8">
            <a href="{{ route('creator.posts.index') }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-sm transition-all" wire:navigate>
            ...
            <a href="{{ route('creator.resources.index') }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-sm transition-all" wire:navigate>
                <div class="flex items-center gap-4">
            ...
            <a href="{{ route('creator.courses.index') }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-sm transition-all" wire:navigate>
                <div class="flex items-center gap-4">
            ...
            <a href="{{ route('profile') }}#creator-profile" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-sm transition-all" wire:navigate>
                <div class="flex items-center gap-4">
            ...
            <a href="{{ route('creators.show', auth()->user()) }}" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-slate-300 dark:hover:border-slate-600 hover:shadow-sm transition-all" wire:navigate>
                <div class="flex items-center gap-4">
