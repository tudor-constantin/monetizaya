                    ...
                    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-5">
                        ...
                        <div class="mt-3 space-y-2">
                            @forelse($recentPosts as $recentPost)
                                <a href="{{ route('creators.posts.show', [$creator, $recentPost]) }}" class="ui-card-hover block rounded-lg border border-slate-200 dark:border-slate-700 px-3 py-2" wire:navigate>
                        ...
                        <div class="mt-5 pt-4 border-t border-slate-200 dark:border-slate-700">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="mailto:?subject={{ $shareTitle }}&body={{ $shareUrl }}" class="inline-flex items-center justify-center w-9 h-9 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 transition-colors" aria-label="{{ __('ui.share_by_email') }}">
